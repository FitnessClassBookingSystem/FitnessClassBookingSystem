...
def register(register_request: RegisterUserRequest) -> RegisterUserResponse:
    return auth_service.register(register_request)

@router.post("/auth/login", tags=["auth"])
def login(login_request: LoginUserRequest) -> LoginUserResponse:
    return auth_service.login(login_request)

@router.post("/auth/logout", tags=["auth"])
def logout(logout_request: LogoutUserRequest) -> LogoutUserResponse:
